...
public final class FurnitureEngine extends JavaPlugin {
	...
	public void onEnable() {
		getLogger().info(
				ChatColor.GOLD + "Furniture" + ChatColor.YELLOW + "Engine" + ChatColor.DARK_GRAY + " » " + ChatColor.GRAY + "Furniture Engine enabled!");
		...
		new UpdateChecker(this, 97134).getVersion(version -> {
			if (this.getDescription().getVersion().equals(version)) {
				...
				getLogger().info(
						ChatColor.GOLD + "Furniture" + ChatColor.YELLOW + "Engine" + ChatColor.DARK_GRAY + " » " + ChatColor.GRAY + "A new version is available: " + ChatColor.RED + "[" + versionOld + "]" + ChatColor.GRAY + " -> " + ChatColor.GOLD + "[" + versionNew + "]");
				getLogger().info(
	...
	public void onDisable() {
		getLogger().info(
				ChatColor.GOLD + "Furniture" + ChatColor.YELLOW + "Engine" + ChatColor.DARK_GRAY + " » " + ChatColor.GRAY + "Furniture Engine disabled!");
	}
	...
	private WorldGuardPlugin getWorldGuard() {
		...
		if (plugin == null || !(plugin instanceof WorldGuardPlugin)) {
			getLogger().info(
					ChatColor.GOLD + "Furniture" + ChatColor.YELLOW + "Engine" + ChatColor.DARK_GRAY + " » " + ChatColor.RED + "WorldGuard not found. Skipping!");
